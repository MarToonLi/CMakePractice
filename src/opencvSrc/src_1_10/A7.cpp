...
void A7(void)
{
	...
	Mat imgSrc_ori = imread("D:/Myself/MachineVision/resources/HaiLun-Apple/3-5/2024_08_02_15_34_22-10/DA2951215/ori/8__DA2951215.png");

	cv::Mat imgSrc;
	cv::resize(imgSrc_ori, imgSrc, cv::Size(256 * 5, 256 * 5));
