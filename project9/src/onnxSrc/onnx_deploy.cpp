...
int yolo_min()
{
	...
	//std::string onnxModelPath = "D:/Myself/MachineVision/HELLEN_Apple_Plug_OCR/bin/release/model_files_defect/3_2_best.onnx";
	std::string onnxModelPath = "F:/Projects/Opencv-100-Questions/src/onnxSrc/3_2_best.onnx";
